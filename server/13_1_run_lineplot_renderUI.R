        ...
        fluidRow(
            column(width = ifelse(input$lineplot_comparision_mode, 6, 12),
                   fluidRow(
                       ...
                       column(width=ifelse(input$lineplot_comparision_mode, 10, 6),
                       ...
                       fluidRow(
                           ...
                           column(width=10,
                                  ...
                                  div(style="display:inline-block; text_align:right;",
                                      #OPTIONS BUTTON 
                                      dropdownButton(label = "Axis Options",icon = icon("gear"),circle = FALSE,status = "success",right=TRUE,
                                                     textInput(inputId="line_title_compare", 
                                                               label="Title", 
                                                               value = ""),
                                                     textInput(inputId="line_xlabel_compare", 
                                                               label="X Label", 
                                                               value = ""),
                                                     textInput(inputId="line_ylabel_compare", 
                                                               label="Y Label", 
                                                               value = "")
                                      ) #end Dropdown Button
                                  ), #end div
                                  div(style="display:inline-block; text_align:right;",
                                      ...
                                      dropdownButton(label = "Download",icon = icon("download"),circle = FALSE,status = "success",right=TRUE,
                                                     ...
                                                     downloadBttn(outputId="downloadLine_compare",
                                                                  label="Download",
                                                                  style="unite",
                                                                  color="success",
                                                                  size="sm",
                                  ...
                                  div(style="display:inline-block; text_align:right;",
                                      dropdownButton(label = "Customize", status="success", right=TRUE, circle = FALSE
                                                     ,sliderInput(inputId="line_size_options_compare",
                                                                  label="Size of Lines",
                                                                  min=0,
                                                                  max=3,
                                                                  step=0.2,
                                                                  value=1)
                                                     ,prettyCheckbox(inputId = "line_show_dots_compare",
                                                                     label="Show Points",
                                                                     value=FALSE)
                                      )
                                  )
