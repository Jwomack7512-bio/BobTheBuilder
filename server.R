...
###################################################################################  
  ...
  source(file.path("server", "server_modelBuild_createVar.R"), local=TRUE)$value
  source(file.path("server", "server_modelBuild_createEqn.R"), local=TRUE)$value
  ...
  source(file.path("server", "server_run_lineplot_renderUI.R"), local=TRUE)$value
